...
void Venom::drawText (const std::string& Text , float Size , float X , float Y , sf::RenderWindow& Window)
{
    ...
    sf::Text RenderText (String, Venom::DEFAULT_FONT);
 ...
 */
void Venom::split(std::vector<std::string>& elems, const std::string& s, const std::string& delimStr)
{
    char delim = delimStr[0];
 ...
 * @return A font with the loaded file.
 */
sf::Font Venom::LoadFont(const std::string& Filename)
{
    sf::Font Font;
